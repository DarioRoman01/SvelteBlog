  ...
  <div class="d-flex justify-center mt-4">
    <div class="d-flex flex-column">
      ...
      <div style="width: 700px;" class="mb-4 mt-3">
        <TextField color="pink lighten-3" bind:value={email} rules={usernameRules}>
          email
        </TextField>
      </div>
      <div style="width: 700px;">
        <TextField type="password" color="pink lighten-3" bind:value={password} rules={passwordRules}>
          password
        </TextField>
      </div>
